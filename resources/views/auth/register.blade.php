...
<div class="auth-animation-container">
    <div class="auth-form-container">
        <form method="POST" action="{{ route('register') }}" id="register-form">
            ...
            <div class="form-row">
                <input type="email" id="email" name="email" placeholder="e-mail" value="{{ old('email') }}" required autocomplete="username">
            </div>
            ...
            <div class="form-row">
                <label class="flex items-center">
                    <input type="checkbox" id="subscribe" name="subscribe" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                    <span class="text-xs text-gray-600 ml-2">I agree to the terms</span>
                </label>
            </div>
